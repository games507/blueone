...
class AjaxadminController extends CController
{
    ...
    public function actionaddPlans()
    {
    	...
    	if(isset($params['sms_limit'])){
    	   $params['sms_limit'] = (integer)$this->data['sms_limit'];
    	}
    ...
    public function actionsmsSettings()
    {
    	...
    	updateOptionAdmin('africas_username',isset($this->data['africas_username'])?$this->data['africas_username']:'' );
    	updateOptionAdmin('africas_apikey',isset($this->data['africas_apikey'])?$this->data['africas_apikey']:'' );
    	updateOptionAdmin('africas_sender',isset($this->data['africas_sender'])?$this->data['africas_sender']:'' );
    	
    	updateOptionAdmin('clickatell_apikey',isset($this->data['clickatell_apikey'])?$this->data['clickatell_apikey']:'' );
    	updateOptionAdmin('clickatell_curl',isset($this->data['clickatell_curl'])?$this->data['clickatell_curl']:'' );
    	updateOptionAdmin('clickatell_unicode',isset($this->data['clickatell_unicode'])?$this->data['clickatell_unicode']:'' );
    	
    	updateOptionAdmin('msg91_authkey',isset($this->data['msg91_authkey'])?$this->data['msg91_authkey']:'' );
    	updateOptionAdmin('msg91_senderid',isset($this->data['msg91_senderid'])?$this->data['msg91_senderid']:'' );
    	updateOptionAdmin('msg91_route',isset($this->data['msg91_route'])?$this->data['msg91_route']:'' );
    	updateOptionAdmin('msg91_unicode',isset($this->data['msg91_unicode'])?$this->data['msg91_unicode']:'' );
    ...
    {    	
        ...
        updateOptionAdmin('services_json',isset($this->data['services_json'])?$this->data['services_json']:'' );     	
    	$this->code=1;
    	$this->msg=t("Settings saved");
    	$this->jsonResponse();
    }
    ...
    {    	
    	...
    	} else $this->msg=t("failed sending sms");
    	$this->jsonResponse();
    }
    ...
    public function actionsaveMapSettings()
    {
	    ...
	    } else $country_name=$this->data['map_default_country'];	  
	    	    
	    updateOptionAdmin('google_geo_api_key',isset($this->data['google_geo_api_key'])?$this->data['google_geo_api_key']:'' ); 
	    updateOptionAdmin('google_distance_method',isset($this->data['google_distance_method'])?$this->data['google_distance_method']:'' ); 
	    updateOptionAdmin('mapbox_method',isset($this->data['mapbox_method'])?$this->data['mapbox_method']:'' ); 	    
	    ...
	    try {					
			...
			updateOptionAdmin('map_default_lat',$resp['lat']); 
	    	updateOptionAdmin('map_default_lng',$resp['long']); 
    ...
    public function actionuploadJsonFile()
    {
    	$upload_dir = AdminFunctions::uploadPath();
        $uploader = new FileUpload('uploadfile');
	    ...
	    $json_file = $_GET['uploadfile'];
	    $json_file.= '<input type="hidden" name="services_json" value="'.$json_file.'">';	  
        echo json_encode(array('success' => 1 ,'json_file'=>$json_file ));        
    }
    
    public function actionremoveServicesJson()
    {
    	updateOptionAdmin("services_json",'');
    	$this->code=1;
    	$this->msg=t("Successful");
    	$this->jsonResponse();
    }
