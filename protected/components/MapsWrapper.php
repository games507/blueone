...
{	
	...
	public static function getMapProvider()
	{
		...
		switch ($map_provider) {
			...
			case "google":	
			    ...
			    $map_api = getOptionA('google_api_key');
	...
	public static function saveLogs($map_provider='', $api_functions='', $api_response='')
	{
		$params = array(
		...
		if(Yii::app()->db->createCommand()->insert("{{api_logs}}",$params)){
			return true;
		}
		return false;
	}
