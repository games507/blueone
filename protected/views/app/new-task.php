<div class="modal new-task" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="recurrent_task_wrap" style="display:none;">
      
       <h5>
           <?php 
           echo CHtml::checkBox('recurrent_task_enabled',false,array(
            'value'=>1,
            'class'=>"recurrent_task_enabled"
           ));
           ?>
           <?php echo Driver::t("Recurrent Task")?>
        </h5>
      
      <div class="recurrent_task_wrap_inner">
      <div class="row">
        <div class="col-md-6">
         ...
         <div class="row">
            <div class="col-md-6">
              <?php 
              echo CHtml::textField('recurrent_task_start_date','',array(
            ...
            <div class="col-md-6">
             <?php 
              echo CHtml::textField('recurrent_task_end_date','',array(
      ...
      <h5 class="top20">      
           <div class="form-check">
		    <?php 
		    echo CHtml::checkBox('recurrent_task_check_all',false,array(
		      'class'=>"form-check-input recurrent_task_check_all",		      
		      'value'=>1
		    ));
		    ?>
		    <label class="form-check-label" style="font-weight:normal;" for="recurrent_task_check_all">
		    <?php echo t("Days to create task")?>
		    </label>
		  </div>
      </h5>
      
      
      <?php $options_days = Driver::returnDays()?>
      <div class="row">
        <?php foreach ($options_days as $day):?>
        <div class="col-md-2" style="padding-right: 0;width: 12%;">
           <div class="form-check">
		    <?php 
		    echo CHtml::checkBox('recurrent_task_days[]',false,array(
		      'class'=>"form-check-input recurrent_task_days rr_day_$day",
		      'id'=>"f_".$day,
		      'value'=>$day,		     
		    ));
		    ?>
		    <label class="form-check-label" style="font-weight:normal;" for="<?php echo "f_".$day;?>">
      ...
      <h5 class="top20">
        ...
        <div class="form-check">
		    <!--<?php 
		    echo CHtml::checkBox('recurrent_task_repetition_check_all',false,array(
		      'class'=>"form-check-input recurrent_task_repetition_check_all",		      
		      'value'=>1
		    ));
		    ?>
		    <label class="form-check-label" style="font-weight:normal;" for="recurrent_task_repetition_check_all">
		    <?php echo t("Task Repetition")?>
		    </label>-->
		    <?php echo t("Task Repetition")?>
		  </div>
      
      </h5>
      <?php $options_repetition = Driver::returnTaskRepetition()?>
      <div class="row">
        <?php foreach ($options_repetition as $period):?>
        <div class="col-md-2" style="padding-right: 0;width: 12%;">
           <div class="form-check">
		    <?php 
		    /*echo CHtml::checkBox('recurrent_task_repetition[]',false,array(
		      'class'=>"form-check-input recurrent_task_repetition rr_repetion_$period",
		      'id'=>"f_".$period,
		      'value'=>$period
		    ));*/
		    echo CHtml::radioButton('recurrent_task_repetition[]',false,array(
		      'class'=>"form-check-input recurrent_task_repetition rr_repetion_$period",
		      'id'=>"f_".$period,
		      'value'=>$period
		    ));
		    ?>
		    <label class="form-check-label" style="font-weight:normal;" for="<?php echo "f_".$period;?>">
		    <?php echo ucwords($period);?>
		    </label>
		  </div>
        </div>
        <?php endforeach;?>
      ...
      </div> <!--recurrent_task_wrap_inner-->
      
      </div><!-- recurrent_task_wrap-->
