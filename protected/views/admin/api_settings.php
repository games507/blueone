...
<div class="card">
 <div class="card-content">
  ...
  <form id="frm" method="POST" onsubmit="return false;">
   <?php echo CHtml::hiddenField('action','apiServicesSettings')?>   
     ...
     <div class="col s6">
	      ...
	      <a href="javascript:;" class="gen_api_services_key"><?php echo t("Click here to generate keys")?></a>
     </div>
   </div>
  ...
  <ul class="collapsible">
     <li>
      ...
      <div class="collapsible-body" style="padding:20px;">           
        ...
        <table class="striped responsive-table">
         ...
         <tr>
          <td><?php echo t("driver_id")?></td>
          <td><?php echo t("")?></td>
          <td><?php echo t("optional")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("dropoff_contact_name")?></td>
          <td><?php echo t("")?></td>
          <td><?php echo t("optional")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("dropoff_contact_number")?></td>
          <td><?php echo t("")?></td>
          <td><?php echo t("optional")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("drop_address")?></td>
          <td><?php echo t("")?></td>
          <td><?php echo t("optional")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("dropoff_task_lat")?></td>
          <td><?php echo t("")?></td>
          <td><?php echo t("optional")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("dropoff_task_lng")?></td>
          <td><?php echo t("")?></td>
          <td><?php echo t("optional")?></td>
         </tr>
     ...
     <li>
      <div class="collapsible-header"><i class="material-icons">reorder</i>
       <?php echo t("INSERT_CONTACT")?>
      </div>
      <div class="collapsible-body" style="padding:20px;">           
      
        <p>
        <?php echo t("API LINK")?> : 
        <a href="<?php echo Driver::getHostURL().Yii::app()->createUrl("api_services/insert_contact")?>" target="_blank">
        <?php echo Driver::getHostURL().Yii::app()->createUrl("api_services/insert_contact")?>
        </a>
        </p>
        ...
        <table class="striped responsive-table">
         ...
         <tr>
          ...
          <td><?php echo t("Contact email")?></td>
          <td><?php echo t("yes")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("phone")?></td>
          <td><?php echo t("Contact phone")?></td>
          <td><?php echo t("yes")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("address")?></td>
          <td><?php echo t("Contact address")?></td>
          <td><?php echo t("yes")?></td>
         </tr>
         
         <tr>
          <td><?php echo t("status")?></td>
          <td><?php echo t("possible values are active , pending")?></td>
          <td><?php echo t("yes")?></td>
         </tr>
