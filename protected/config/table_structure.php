...
CREATE TABLE IF NOT EXISTS ".$table_prefix."contacts (
  ...
  `addresss_lat` varchar(50) NOT NULL DEFAULT '',
  `addresss_lng` varchar(50) NOT NULL DEFAULT '',
  `status` varchar(100) NOT NULL DEFAULT 'pending',
  `date_created` $date_default,
  `date_modified` $date_default,
  `ip_address` varchar(50) NOT NULL DEFAULT ''
...
CREATE TABLE IF NOT EXISTS ".$table_prefix."services (
  ...
  `sevices_name` varchar(255) NOT NULL DEFAULT '',
  `description` text,
...
CREATE TABLE IF NOT EXISTS ".$table_prefix."promo_code (
  ...
  `promo_code_name` varchar(25) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS ".$table_prefix."driver_track_location (
  ...
  `accuracy` varchar(50) NOT NULL DEFAULT '',
  `altitudeAccuracy` varchar(50) NOT NULL DEFAULT '',
  `heading` varchar(50) NOT NULL DEFAULT '',
  `speed` varchar(50) NOT NULL DEFAULT '',
  `date_created` $date_default,
  `ip_address` varchar(50) NOT NULL DEFAULT '',
